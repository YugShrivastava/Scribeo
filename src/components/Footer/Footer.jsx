...
function Footer() {
  return (
    <div className="relative flex flex-wrap items-center justify-center gap-2 sm:gap-14 py-4 w-full bg-gray-800 bottom-0 text-center text-gray-100 dark:text-gray-300 dark:bg-[hsl(0,0%,17%)] ">
